...
public class ProximityRecorder extends BaseRecorderService {
    private String configFileName;
    private String fileHeaderText;

    public ProximityRecorder() {
        super("Proximity Recorder");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        fileHeaderText = Util.prepareFileHeader(getString(R.string.sensor_proximity), frequency, precision);
    ...
    public void onCreate() {
        super.onCreate();
        configFileName = getString(R.string.proximity_config_fileName);
