...
public class LightRecorder extends BaseRecorderService {
    private String configFileName;
    private String fileHeaderText;

    public LightRecorder() {
        super("Light Recorder");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        fileHeaderText = Util.prepareFileHeader(getString(R.string.sensor_light), frequency, precision);
    ...
    public void onCreate() {
        super.onCreate();
        configFileName = getString(R.string.light_config_fileName);
