...
public class AccelerationRecorder extends BaseRecorderService{
    private String configFileName;
    private String fileHeaderText;

    public AccelerationRecorder() {
        super("AccelerationRecorder");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        fileHeaderText = Util.prepareFileHeader(getString(R.string.sensor_linear_acceleration), frequency, precision);
    ...
    public void onCreate() {
        super.onCreate();
        configFileName = getString(R.string.acceleration_config_fileName);
