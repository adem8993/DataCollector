...
public class RotationVectorRecorder extends BaseRecorderService {

    private String configFileName;
    private String fileHeaderText;

    public RotationVectorRecorder() {
        super("Rotation Vector Recorder");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        fileHeaderText = Util.prepareFileHeader(getString(R.string.sensor_rotation_vector), frequency, precision);
    ...
    public void onCreate() {
        super.onCreate();
        configFileName = getString(R.string.rotation_config_fileName);
